...
export const EmbedRequestEncodingFormat = {
    Base64: "base64",
} as const;
export type EmbedRequestEncodingFormat = (typeof EmbedRequestEncodingFormat)[keyof typeof EmbedRequestEncodingFormat];
