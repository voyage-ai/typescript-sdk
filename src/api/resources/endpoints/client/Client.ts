...
export class Endpoints {
     ...
     *
     * @param {VoyageAI.ContextualizedembeddingsApiRequest} request
     ...
     *     })
     */
    public async contextualizedembeddingsApi(
        request: VoyageAI.ContextualizedembeddingsApiRequest,
        requestOptions?: Endpoints.RequestOptions
    ): Promise<VoyageAI.ContextualizedembeddingsApiResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.ContextualizedembeddingsApiRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return serializers.ContextualizedembeddingsApiResponse.parseOrThrow(_response.body, {
